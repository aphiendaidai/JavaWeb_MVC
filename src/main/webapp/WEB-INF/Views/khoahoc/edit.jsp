        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header bg-primary text-white">
                    <h3 class="card-title mb-0"><i class="fas fa-edit me-2"></i>Chỉnh sửa khóa học</h3>
                </div>
                <div class="card-body">
                    <form:form method="POST" modelAttribute="khoahoc">
                        <div class="mb-3">
                            <label for="maKH" class="form-label">Mã khóa học</label>
                            <form:input path="maKH" id="maKH" cssClass="form-control" readonly="true"/>
                        ...
                        <div class="mb-3">
                            ...
                            <form:input path="thoiGian" id="thoiGian" cssClass="form-control"/>
