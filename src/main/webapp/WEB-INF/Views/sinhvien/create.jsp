        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header bg-primary text-white">
                    <h3 class="card-title mb-0"><i class="fas fa-user-plus me-2"></i>Thêm sinh viên mới</h3>
                </div>
                <div class="card-body">
                    <form:form action="${pageContext.request.contextPath}/sinhvien" 
                             method="POST" 
                             modelAttribute="sinhviens">
                        
                        <div class="mb-3">
                            <label for="maSV" class="form-label">Mã sinh viên <span class="text-danger">*</span></label>
                            <form:input path="maSV" id="maSV" cssClass="form-control"/>
                        ...
                        <div class="mb-3">
                            ...
                            <form:input path="ngaySinh" type="date" id="ngaySinh" cssClass="form-control"/>
